...
<pre>
git clone https://github.com/morrislaptop/settings app/Plugin/Settings
</pre>
...
<pre>
cake schema create -plugin settings
</pre>
	
Make sure your are parsing the JSON extension in your routes.php
